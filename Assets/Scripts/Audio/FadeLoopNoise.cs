...
/// <summary>
/// Handles looping a ControlledNoise by continuously fading a new copy in as the old copy fades out.
/// </summary>
public class FadeLoopNoise
{
    public static GameObject SoundLoopContainer = null;

    /// <summary>
    /// The ControlledNoise to loop.
    /// </summary>
    public GameObject Loop { get; private set; }
    ...
    public FadeLoopNoise(GameObject toLoop, string loopName)
    {
        if (SoundLoopContainer == null)
        {
            SoundLoopContainer = new GameObject("Looped Sounds");
        }
    ...
    {
        GameObject copy = WorldConstants.Creator.CreateNewCopy(Loop);
    ...
    public void UpdateLoop()
    {
        ...
        if (!Running)
        {
            throw new InvalidOperationException("Must start the loop first!");
        }
